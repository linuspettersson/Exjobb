...
#                           axis=0)
#input_img = np.concatenate(img1.reshape((1, 28, 28, 1)), axis=0)
input_img = img1.reshape((1, 28, 28, 1))
...
# variable config=tf.ConfigProto(gpu_options=tf.GPUOptions(per_process_gpu_memory_fraction=0.50))
